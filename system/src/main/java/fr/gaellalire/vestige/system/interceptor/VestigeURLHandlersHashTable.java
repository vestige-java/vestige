...
public class VestigeURLHandlersHashTable extends Hashtable<String, URLStreamHandler> implements StackedHandler<Hashtable<String, URLStreamHandler>> {
    ...
    private URLStreamHandler jarURLStreamHandler;

    public VestigeURLHandlersHashTable(final VestigeSystemHolder vestigeSystemHolder, final URLStreamHandler jarURLStreamHandler) {
