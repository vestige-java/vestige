 ...
 * @author Gael Lalire
 */
public interface InstallerAttachmentDescriptor extends AttachmentDescriptor {

    String getClassName() throws ApplicationException;

    boolean isPrivateSystem() throws ApplicationException;
