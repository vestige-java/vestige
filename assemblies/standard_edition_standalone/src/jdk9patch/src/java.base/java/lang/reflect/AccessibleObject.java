...
public class AccessibleObject implements AnnotatedElement {
     ...
     */
    @CallerSensitive
    public static void setAccessible(AccessibleObject[] array, final boolean flag) {
        checkPermission();
        if (flag) {
     ...
     */
    boolean setAccessible0(final boolean flag) {
        this.override = flag;
        return flag;
    }
    ...
    */
    void checkCanSetAccessible(final Class<?> caller) {
        // do nothing, needs to be overridden by Constructor, Method, Field
    }

    void checkCanSetAccessible(final Class<?> caller, final Class<?> declaringClass) {
    }
     ...
     */
    @CallerSensitive
    public final boolean canAccess(final Object obj) {
        if (!Member.class.isInstance(this)) {
            return override;
        }
    ...
    final void checkAccess(final Class<?> caller, final Class<?> memberClass,
                           final Class<?> targetClass, final int modifiers)
    ...
    final boolean verifyAccess(final Class<?> caller, final Class<?> memberClass,
                               final Class<?> targetClass, final int modifiers)
    {
    ...
    private boolean slowVerifyAccess(final Class<?> caller, final Class<?> memberClass,
                                     final Class<?> targetClass, final int modifiers)
    {
