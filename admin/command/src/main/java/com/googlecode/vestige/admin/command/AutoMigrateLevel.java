...
import com.googlecode.vestige.admin.command.argument.LevelArgument;
...
public class AutoMigrateLevel implements Command {
    ...
    public List<Argument> getArguments() {
        return Arrays.asList(repositoryArgument, applicationArgument, versionArgument, levelArgument);
    }

    public void execute(final PrintWriter out) {
        try {
            applicationManager.setAutoMigrateLevel(repositoryArgument.getRepository(), applicationArgument.getApplication(),
                    versionArgument.getVersion(), levelArgument.getLevel());
