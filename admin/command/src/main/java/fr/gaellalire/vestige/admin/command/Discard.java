...
public class Discard implements Command {
    ...
    public Discard(final ApplicationManager applicationManager) {
    ...
    public String getDesc() {
        return "Discard an application state";
    }
    ...
    public JobController execute(final CommandContext commandContext) {
        try {
            applicationManager.discard(applicationArgument.getApplication());
