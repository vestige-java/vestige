 ...
 * @author Gael Lalire
 */
public class DescriptorReload implements Command {

    private ApplicationManager applicationManager;

    private LocalApplicationNameArgument applicationArgument;

    public DescriptorReload(final ApplicationManager applicationManager) {
    ...
    public String getDesc() {
        return "Reload the descriptor of an application";
    }
    ...
    public JobController execute(final CommandContext commandContext) {
        try {
            return applicationManager.reloadDescriptor(applicationArgument.getApplication(), commandContext.getJobListener());
